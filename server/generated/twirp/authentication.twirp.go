...
func NewAuthenticationServiceProtobufClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) AuthenticationService {
	...
	serviceURL += baseServicePath(pathPrefix, "user", "Authentication")
	urls := [1]string{
...
func (c *authenticationServiceProtobufClient) Authenticate(ctx context.Context, in *AuthenticateReq) (*AuthenticateRes, error) {
	...
	ctx = ctxsetters.WithServiceName(ctx, "Authentication")
...
const AuthenticationServicePathPrefix = "/twirp/user.Authentication/"
...
func (s *authenticationServiceServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	if pkgService != "user.Authentication" {
...
func (s *authenticationServiceServer) PathPrefix() string {
	return baseServicePath(s.pathPrefix, "user", "Authentication")
}
...
var twirpFileDescriptor0 = []byte{
	...
	0x33, 0xf5, 0xd0, 0x9c, 0x22, 0x85, 0x55, 0xb8, 0xd8, 0xc9, 0x38, 0xca, 0x30, 0x3d, 0xb3, 0x24,
	...
	0x6a, 0x11, 0xc8, 0x1d, 0x10, 0xa9, 0x24, 0x36, 0xb0, 0x87, 0x8d, 0x01, 0x01, 0x00, 0x00, 0xff,
	0xff, 0x41, 0x44, 0x46, 0x8f, 0x32, 0x01, 0x00, 0x00,
}
